...
class resnet_v1_101_rcnn_dcn_dcr_res2(Symbol):
    def __init__(self):
        """
    ...
    def dcr_branch(self, res2c_relu, dilate=False):
        if dilate:
            res5_stride = 1
            res5_dilate = 2
        else:
        ...
        res5a_branch1 = mx.symbol.Convolution(name='dcr_res5a_branch1', data=res4b22_relu, num_filter=2048, pad=(0, 0),
                                              kernel=(1, 1), stride=(res5_stride, res5_stride), no_bias=True)
        ...
        res5a_branch2b = mx.symbol.Convolution(name='dcr_res5a_branch2b', data=res5a_branch2a_relu, num_filter=512,
                                               pad=(res5_dilate, res5_dilate), dilate=(res5_dilate, res5_dilate),
                                               kernel=(3, 3), stride=(1, 1), no_bias=True)
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        dcr_branch = self.dcr_branch(res2_roi_pool, dilate=cfg.DCR.dilate)
