...
class resnet_v1_101_fpn_dcn_rcnn_dcr_res2(Symbol):
    def __init__(self):
        """
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        if is_train:
            ...
            group = mx.sym.Group([rpn_cls_output, rpn_bbox_loss, cls_prob, bbox_loss, dcr_prob,
    ...
    def get_symbol_test(self, cfg, is_train=False):
        ...
        assert is_train==False, 'This symbol is for test only'
